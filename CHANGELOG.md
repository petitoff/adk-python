...
* Evaluation UI Improvements:
  ...
  * Save the last run threshold and use it in next run evaluation ([8488ff0](https://github.com/google/adk-python/commit/8488ff052f30bfb6a1b74973d645f6627781f26f))
...
* Forwards `__annotations__` to the fake func for FunctionTool inspection ([9abb841](https://github.com/google/adk-python/commit/9abb8414da1055ab2f130194b986803779cd5cc5))
